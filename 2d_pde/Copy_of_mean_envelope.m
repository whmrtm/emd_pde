...
dt=CFL./k;                         %Width of each time step
nt=round(T./dt);                           %Number of time steps 
dx=1;                     %Width of space step(x)
dy=1;                     %Width of space step(y)
x=1:nx;                        %Range of x(0,2) and specifying the grid points
y=1:ny;                        %Range of y(0,2) and specifying the grid points
% u=double(signal);                  %Preallocating u (initial signal)
